...
// NOTE (karimdeif fork): upstream shipped a checkForUpdate() here that called
// api.github.com/repos/<repo>/commits/HEAD on every healthCheck. Removed — this
// deployment makes no outbound network calls of its own; the only socket the
// server opens is CDP on 127.0.0.1. Check for updates with `git fetch` instead.
